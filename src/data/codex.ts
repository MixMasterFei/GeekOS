...
export const CODEX: CodexSection[] = [
  {
    ...
    entries: [
      ...
      { id: 'team', image: '/art/news-carve-1.jpg', name: 'The People', sub: 'Named across three BlizzCon panels', text: 'The What\'s Next panel — Senior Game Director Ion Hazzikostas, Lead Classic Designer Tim Jones, Lead Software Engineer Nora Mills, and Associate Production Director Clay Stone — introduced Forever\'s new regions, dungeons, raids, and the Skyborne. The Deep Dive panel — Clay Stone, Senior Game Designer Josh Greenfield, Lead Software Engineer Ana Resendez, and Principal Game Designer Kris Zierhut — went deeper on Camping, the Legacy system, and combat updates. The Found Photos panel — Josh Greenfield and Lead Content Designer Evan Lee — covered how forgotten corners of original Azeroth helped inspire Forever\'s new regions and quests.' },
    ],
  },
  {
