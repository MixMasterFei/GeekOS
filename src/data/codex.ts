...
export const CODEX: CodexSection[] = [
  {
    ...
    entries: [
      ...
      { id: 'foundphotos', name: 'Found Photos', sub: 'A dedicated BlizzCon panel on design philosophy', text: "A mountain trail that seemed to keep going. A sealed gate. A name on a map. A ruin behind the trees that felt important even though no quest ever sent you there. BlizzCon 2026's Found Photos panel was built around exactly that feeling: taking long-overlooked corners of the original world and turning them into starting points for new adventures — the same instinct behind hidden zones like Shen'dralas." },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'forsakenpal', image: '/art/forsaken-paladin.jpg', name: 'Forsaken Paladin', sub: 'New combination', faction: 'horde', text: "The Light, undying. Warcraft III Reforged: Forsaken Kingdom traces the combination's roots back to the fall of Lordaeron and the founding of the Undercity. GeekOS lets you roll one at the character screen." },
  ...
  },
  {
    ...
    entries: [
      { id: 'heroic', image: '/art/heroic-comp.jpg', name: 'Skyborne Heroic Pack', sub: 'Optional upgrade', text: "Skyborne race access, the Zephras Isle starting experience, and Early Name Reservation. Adds the Shen'dorei Skyseer's Garb, the Veteran Adventurer's Rucksack, and the Shen'dorei Windwell toy, plus the Cerulean Prideclaw ground mount (the riding skill still has to be bought in-game), Skyborne housing decor, and one Invite-A-Friend Launch Code." },
      { id: 'epic', image: '/art/epic-comp.jpg', name: 'Skyborne Epic Pack', sub: 'Optional upgrade', text: 'Everything in Heroic, plus beta access from September 17, 30 days of Game Time, additional Veteran Adventurer-inspired cosmetics, tabards, collection pets, and two more Invite-A-Friend Launch Codes (three total).' },
      { id: 'collection', image: '/art/collection.jpg', name: 'Warcraft Forever Collection', sub: 'Limited time · through January 11, 2027', text: "Everything in Epic, plus Warcraft III: Reforged, the Forsaken Kingdom campaign, and Forsaken and Human figurine housing decor — tying Warcraft's strategy roots to Forever's story, including the origins of the Forsaken Paladins and the Undercity. Made in celebration of BlizzCon 2026." },
