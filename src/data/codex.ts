...
export const CODEX: CodexSection[] = [
  {
    ...
    entries: [
      ...
      { id: 'panels', image: '/art/feat-systems.jpg', name: 'Deep Dive & Found Photos', sub: 'Two more BlizzCon panels', text: "Beyond the reveal and the What's Next panel, a Deep Dive panel went further into Camping, the Legacy system, and combat updates, led by Clay Stone, Senior Game Designer Josh Greenfield, Lead Software Engineer Ana Resendez, and Principal Game Designer Kris Zierhut. A separate Found Photos panel, with Josh Greenfield and Lead Content Designer Evan Lee, traced how forgotten corners and unfinished threads of the original world shaped the reimagined 1–60 regions, quests, and characters." },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      { id: 'heroic', image: '/art/heroic-comp.jpg', name: 'Skyborne Heroic Pack', sub: 'Optional upgrade', text: "Skyborne race access, the Zephras Isle starting experience, the Cerulean Prideclaw mount with a matching Shen'dorei Skyseer's Garb transmog set, a Veteran Adventurer's Rucksack back transmog, early name reservation, housing decor, and one Invite-A-Friend code." },
      { id: 'epic', image: '/art/epic-comp.jpg', name: 'Skyborne Epic Pack', sub: 'Optional upgrade', text: "Everything in Heroic, plus beta access from September 17, 30 days of Game Time, a Veteran Adventurer's Loyal Companion mount and Outdoor Wear transmog set, four pets (Zergling, Panda, Diablo, and Pachimari), Lordaeron and Shen'dorei tabards, and three Invite-A-Friend codes." },
