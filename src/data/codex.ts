...
export const CODEX: CodexSection[] = [
  {
    ...
    entries: [
      ...
      { id: 'deepdive', image: '/art/feat-systems.jpg', name: 'The Deep Dive', sub: 'A second BlizzCon panel', text: 'A follow-up panel, the Forever Deep Dive, went further into the systems shaping the game. Associate Production Director Clay Stone was joined by Senior Game Designer Josh Greenfield, Lead Software Engineer Ana Resendez, and Principal Game Designer Kris Zierhut to walk through Camping, Legacy system progression, and combat updates.' },
      { id: 'foundphotos', image: '/art/feat-journey.jpg', name: 'Found Photos', sub: 'Why familiar corners get new stories', text: "A third panel, Found Photos, laid out the design philosophy behind Forever's new content. Senior Game Designer Josh Greenfield and Lead Content Designer Evan Lee described treating Azeroth's forgotten corners, unfinished threads, and long-held player memories as the starting point for the reimagined regions, quests, characters, and locations woven through the 1-60 journey." },
    ],
  },
  {
