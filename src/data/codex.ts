...
export const CODEX: CodexSection[] = [
  {
    ...
    entries: [
      ...
      { id: 'panels', image: '/art/feat-systems.jpg', name: 'Deep Dive & Found Photos', sub: 'Two more BlizzCon panels', text: 'The Forever Deep Dive, presented by Clay Stone, Senior Game Designer Josh Greenfield, Lead Software Engineer Ana Resendez, and Principal Game Designer Kris Zierhut, went further into the systems shaping the game: Camping, Legacy progression, and combat updates. The Found Photos panel, presented by Josh Greenfield and Lead Content Designer Evan Lee, explained the philosophy behind it all: mining original Azeroth\'s forgotten corners, unfinished threads, and long-held player memories to expand the level 1–60 journey with reimagined regions, quests, characters, and stories.' },
    ],
  },
  {
