...
export const CODEX: CodexSection[] = [
  {
    ...
    entries: [
      ...
      { id: 'deepdive', name: 'The Deep Dive Panel', sub: 'Systems, up close', text: 'Associate Production Director Clay Stone, Senior Game Designer Josh Greenfield, Lead Software Engineer Ana Resendez, and Principal Game Designer Kris Zierhut walked through the systems shaping Forever, including Camping, Legacy progression, and combat updates.' },
      { id: 'foundphotos', name: 'The Found Photos Panel', sub: 'Where the ideas came from', text: 'Senior Game Designer Josh Greenfield and Lead Content Designer Evan Lee shared how forgotten corners, unfinished threads, and long-held player memories from the original world inspired Forever, and how the team is using them to expand the level 1–60 journey.' },
    ],
  },
  {
