...
export const CODEX: CodexSection[] = [
  {
    ...
    entries: [
      ...
      { id: 'deepdive', image: '/art/feat-systems.jpg', name: 'The Deep Dive', sub: 'A closer look at the systems', text: 'A second BlizzCon panel went further into how Forever plays. Associate Production Director Clay Stone, Senior Game Designer Josh Greenfield, Lead Software Engineer Ana Resendez, and Principal Game Designer Kris Zierhut walked through Camping, Legacy system progression, and combat updates.' },
      { id: 'foundphotos', image: '/art/feat-journey.jpg', name: 'Found Photos', sub: 'Where the new regions came from', text: 'A third panel traced the design roots of Forever\'s new content. Senior Game Designer Josh Greenfield and Lead Content Designer Evan Lee described how forgotten corners, unfinished threads, and long-held player memories of original Azeroth became the starting point for the reimagined regions, quests, characters, and locations in the 1–60 journey.' },
    ],
  },
  {
