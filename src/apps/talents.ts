...
const TALENTS: Talent[] = [
  ...
  { id: 'big-text', name: 'Large Runes', desc: 'Bigger interface text.', icon: 'scribe', tier: 3, col: 0, unlockLevel: 8, apply: on => { document.documentElement.classList.toggle('big', on); store.set('ui.big', on); }, state: () => store.get('ui.big', false) },
