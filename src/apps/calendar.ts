...
export const FOREVER_EVENTS: CalEvent[] = [
  ...
  { id: 'names', date: '2026-10-27', endDate: '2026-11-03', title: 'Early name reservation', kind: 'info', desc: 'Create and customize up to three characters and reserve their names before launch (Heroic Pack or higher). First-come, first-served — desired names aren\'t guaranteed.' },
