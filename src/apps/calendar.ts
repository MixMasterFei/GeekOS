...
export const FOREVER_EVENTS: CalEvent[] = [
  ...
  { id: 'names', date: '2026-10-27', endDate: '2026-11-03', title: 'Early name reservation', kind: 'info', desc: 'Reserve names for up to three characters before launch, first-come first-served (Heroic Pack or higher).' },
