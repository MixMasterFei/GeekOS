...
const TIPS = [
  ...
  "Three raids unlock December 9: Hyjal Summit, Barrow Deeps, and a returning Onyxia's Lair at 40 players.",
  'Beta opt-in is free on Battle.net, though a seat is not guaranteed. The Skyborne Epic Pack and above include guaranteed access.',
  'Legacy has three panels: Challenges, Tree, and Progress Track. Six challenge categories cover exploring, levelling, tradeskills, PvP, reputations, and dungeons and raids.',
